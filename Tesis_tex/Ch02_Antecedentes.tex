...
\textcolor{green}{Mencionar que las características no son la única forma de reconocer objetos. Existen también las técnicas de aprendizaje de máquina como las redes neuronales. Se utilizaron características por el bajo costo computacional. Agregar que por la naturaleza de los objetos a reconocer, un reconocimiento por características es más efectivo y mucho menos costoso. }
