...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{Figures/AllMeans.png}
        \caption{}
        \label{fig:AllMeans}
\end{figure}

Durante las pruebas realizadas, se observó que existe la posibilidad de confusión entre las piezas amarilla y verde. Esta confusión puede deberse a que en la escala de colores correspondiente al espacio HSV usado por la paquetería OpenCV la diferencia entre el valor Hue de ambas piezas es muy similar (ver)

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{Figures/hsv_colormap_opencv.png}
