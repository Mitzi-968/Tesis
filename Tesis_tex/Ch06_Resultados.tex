...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{Figures/Arm_RestPos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{Figures/Arm_MovPlan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{Figures/Grasping_sequence.png}
