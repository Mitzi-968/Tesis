        ...
        \subsection{Herramientas de hardware}
            ...
            \begin{figure}[H]
                \centering\includegraphics[scale=0.3]{Figures/RobotinoFESTO_base+torre.png}
                    \caption{Robotino 3 - Imagen obtenida de \cite{festo-didactic-robotino-2013}}
                    \label{fig:Robotino}
            \end{figure}
